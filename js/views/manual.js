  ...
  container.innerHTML = `
    ...
    <div class="card">
      ...
      <ol class="hint" style="font-size:13px;color:var(--text);line-height:2;padding-left:18px;">
        <li><b>職員マスタ</b>で職員を登録します。職種・所属ユニット・常勤区分・資格（配置基準に算入できるか）・育児短時間勤務・深夜業免除の対象かどうかを設定してください。</li>
    ...
    <div class="card">
      ...
      <table>
        <tbody>
          <tr><td style="width:180px;">セルを<b>左クリック</b></td><td>そのセルのプルダウンから勤務パターン／公休／年休を選んで割り当てます。</td></tr>
          <tr><td>セルを<b>右クリック</b></td><td>希望休の申請フラグをON/OFFします（黄色い枠で表示）。実際の割当は変わりません。</td></tr>
